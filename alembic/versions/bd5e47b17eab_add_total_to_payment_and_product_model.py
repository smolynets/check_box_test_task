...
Revision ID: bd5e47b17eab
Revises: b825d4a49c1f
Create Date: 2024-09-22 15:40:55.845768
...
def upgrade() -> None:
    ...
    op.add_column('payments', sa.Column('payment_total', sa.Numeric(precision=10, scale=2), nullable=False))
    op.add_column('payments', sa.Column('rest', sa.Numeric(precision=10, scale=2), nullable=True))
    op.add_column('products', sa.Column('product_total', sa.Numeric(precision=10, scale=2), nullable=False))
